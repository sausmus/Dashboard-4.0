(() => {
  ...
  function normalizeData(raw) {
    ...
    const data = {
      ...
      classroom: normalizeClassroom(raw.classroom),
      calendar: {
  ...
  function saveClassroomRoster(classId, course, students) {
    ...
    // Existing Dashboard utilities continue to consume the simple name roster.
    data.classes[id].students = normalizeStudents(
      normalizedStudents.map(student => student.name)
    );
